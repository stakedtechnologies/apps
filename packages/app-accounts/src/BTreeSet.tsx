...
import { Constructor, Codec, IHash, InterfaceTypes, Registry, AnyJsonArray } from '@polkadot/types/types';

import { isHex, hexToU8a, isU8a, u8aConcat, u8aToHex, u8aToU8a } from '@polkadot/util';
import { blake2AsU8a } from '@polkadot/util-crypto';

import { U8a, Compact } from '@polkadot/types';
import { decodeU8a, typeToConstructor } from '@polkadot/types/codec/utils';
...
export function compareSet (a: Set<any>, b?: any): boolean {
  if (Array.isArray(b)) {
